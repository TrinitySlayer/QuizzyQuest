...
func _ready():
	set_health($CikguMathContainer/ProgressBar, enemy.health, enemy.health)
	set_health($PlayerPanel/PlayerData/ProgressBar, State.current_health, State.max_health)
	$CikguMathContainer/CikguMath.texture = enemy.texture
	...
	display_text(" Penjaga : Siapakah yang mencipta bendera Malaysia? " )
	await textbox_closed
	$ActionPanel.show()
...
func _on_jawapan_1_pressed():
	...
	set_health($CikguMathContainer/ProgressBar, current_enemy_health, enemy.health)
	...
	if current_enemy_health == 0:
		...
		get_tree().change_scene_to_file("res://scenes/cliff_side_win.tscn") #Jangan tukar
...
func _on_jawapan_2_pressed():
	...
	if current_player_health == 0:
		display_text(" AAnda tidak berjaya mengalahkan penjaga ")
		await textbox_closed
...
func _on_jawapan_1_toggled(toggled_on):
	$ClickBtn.play()
